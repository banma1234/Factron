...
public class RequestClientDTO {
    ...
    @Builder
    public RequestClientDTO(String name, String business_number, String address, String contact, String ceo, String contact_manager, String remark) {
        this.name = name;
     ...
     * */
    public static Client toEntity(RequestClientDTO DTO) {
