...
const init = () => {
    ...
    approvalGrid.on('dblclick', (e) => {
        ...
        switch (rowData.apprTypeCode) {
            case "APR003": formUrl = "/approval/transferApproval-form"; break;
            case "APR002": formUrl = "/approval/vacationApproval-form"; break;
            case "APR001": formUrl = "/approval/workApproval-form"; break;
